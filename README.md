- 👋 Hi, I’m @Fusse111poli
echo: WELCOME TO SCRPIT
X=MsgBox("Error while opening. Do you want to fix this problem ?",4+64,"Error")

X=MsgBox("The problem can' be fixed !",0+48,"Error")
...
X=MsgBox("LOL.... Just kidding !",0+16,"No Virus Detected")

X=MsgBox("I made this from YOU GOT TROLLD",0+16,"There is no virus !")



----------------------------------------------------------------------------

copy this in text and name it Computer.VBs This you can open on your own Computer Its only A fake virus ( Created by ANOMAN )
